...
@Component({
  selector: 'app-usermoderator',
  templateUrl: './usermoderator.component.html',
  styleUrls: ['./usermoderator.component.css']
})
export class UsermoderatorComponent implements OnInit {
